...
const journeyLocations = [
  ...
  { id: 10, name: "Buenos Aires, Argentina", year: "1912", desc: "Bác ghé thăm thủ đô Buenos Aires (Argentina), dành thời gian tìm hiểu phong trào đấu tranh và đời sống thực tế của giai cấp công nhân Nam Mỹ trước khi tiếp tục hành trình sang Bắc Mỹ.", coords: [-34.6, -58.3] as [number, number] },
